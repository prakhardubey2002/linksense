...
React hooks for URL platform detection, normalization, and extraction. Powered by [`@linksense/core`](https://www.npmjs.com/package/@linksense/core).

## Install

```bash
# npm
npm install @linksense/react react

# pnpm
pnpm add @linksense/react react

# yarn
yarn add @linksense/react react
```
...
```tsx
import { useDetectAll } from "@linksense/react";
...
```tsx
import { useNormalizeUrl } from "@linksense/react";
...
```tsx
import { useExtractFromUrl } from "@linksense/react";
